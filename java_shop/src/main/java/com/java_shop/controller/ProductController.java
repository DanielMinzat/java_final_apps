...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse> saveProduct(@RequestBody Product product){
        ...
        return ResponseEntity.ok(ApiResponse.success("Produsul a fost salvat cu success",savedProduct));
    }
    ...
    public ResponseEntity<ApiResponse> updateProduct(@RequestBody Product product){
        ...
        return ResponseEntity.ok(ApiResponse.success("Produsul a fost modificat cu success",updatedProduct));
    }
